...
(0, _jquery2.default)(function () {
    var updateZipCode = function updateZipCode() {
        (0, _jquery2.default)('.content-block .zip-code').text(_store2.default.getState().zip);
    };
    updateZipCode();
    _store2.default.subscribe(updateZipCode);
});
