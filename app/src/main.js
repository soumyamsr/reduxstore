...
(0, _jquery2.default)('#findStore').on('click', function () {
   var newValue = (0, _jquery2.default)('input[name=store-input]').val();
   var storeType = isNaN(newValue) ? 'NAME' : 'ZIP';
   _store2.default.dispatch({ type: storeType, payload: {
         zip: newValue
      } });
});

},{"./store":2,"jquery":3}],2:[function(require,module,exports){
'use strict';
...
var store = (0, _redux.createStore)(locateStore);

exports.default = store;

},{"redux":20}],3:[function(require,module,exports){
/*!
